...
공개 DCInside 정식·마이너 갤러리의 최근 게시물을 수집하고, 규칙 기반 필터로 20개를 추린 뒤 로컬 Codex CLI가 YouTube Shorts 소재 후보 5개를 선정하는 Windows 11용 CLI다.
...
목록 수집 후 게시물 본문을 순차 요청하는 동안 명령창과 `run.log`에 다음과 같은 진행 상황이 약 5% 간격으로 표시된다.
